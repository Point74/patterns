...
////////////////////////////////////////////////////////////
/// \brief RealImage living on the graphics card that can be used for drawing
///
////////////////////////////////////////////////////////////
...
public:
    ...
    /// If this function fails, the texture is left unchanged.
    ///
    /// \param image RealImage to load into the texture
    /// \param area  Area of the image to load
    ///
    /// \return True if loading was successful
    ///
    ...
    ///
    /// \return RealImage containing the texture's pixels
    ///
    /// \see loadFromImage
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// previously created.
    ///
    /// \param image RealImage to copy to the texture
    ///
    ////////////////////////////////////////////////////////////
...
/// A texture cannot be manipulated as freely as a sf::RealImage,
/// you need to prepare the pixels first and then upload them
/// to the texture in a single operation (see Texture::update).
///
/// sf::Texture makes it easy to convert from/to sf::RealImage, but
...
/// sf::RealImage, do whatever you need with the pixels, and then call
...
/// of booleans.
///
/// Like sf::RealImage, sf::Texture can handle a unique internal
...
/// \endcode
///
/// \see sf::Sprite, sf::RealImage, sf::RenderTexture
///
////////////////////////////////////////////////////////////
