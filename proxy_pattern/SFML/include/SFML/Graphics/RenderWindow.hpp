...
public:
    ...
    /// function and copy its contents into an sf::RealImage instead.
    /// \code
    /// sf::Vector2u windowSize = window.getSize();
    /// sf::Texture texture;
    /// texture.create(windowSize.x, windowSize.y);
    /// texture.update(window);
    /// sf::RealImage screenshot = texture.copyToImage();
    /// \endcode
    ///
    ...
    ///
    /// \return RealImage containing the captured contents
    ///
    ////////////////////////////////////////////////////////////
